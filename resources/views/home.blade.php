...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
                ...
                <div class="card mb-3 cardProduct" style="width: 100%;">
                    <div class="row g-0">
                        <div class="col-md-4 cardImg">
                            ...
                            <img id="productImg" src="/img/bose-qc35.png" alt="Image logo product"  style="margin-top:10px; width:310px; height:453px;">
                            
                            <div style="width: 100%;">
                                <div style="float:left;">
                                    <div class="arrowLeft" onclick="passImg('arrowLeft')"></div>
                                    <img src="/img/QC35-front.png" style="margin-top:45px; margin-left:20px">
                                </div>
                                <div style="float:left; width:50%">
                                    <div id="circle1" class="circleImg"></div>
                                    <div id="circle2" class="circleImg"></div>
                                    <div id="circle3" class="activeCircle circleImg"></div>
                                    <div id="circle4" class="circleImg"></div>
                                    <div id="circle5" class="circleImg"></div>
                                </div>
                                <div style="float: left; margin-right:0px;">
                                    <img src="/img/qc35 btns.png" style="margin-top: 45px;">
                                    <div class="arrowLeft" onclick="passImg('arrowRight')" style="transform: rotate(225deg);"></div>
                                </div>
                                <br style="clear: left;" />
                            </div>
        ...
        <script>
            var count = 3 ;
            function passImg(side){
                if('arrowLeft' == side){
                    if(count>1){
                        count--;
                        $('#productImg').attr("src", "/img/"+count+".png");
                        $('.circleImg').removeClass("activeCircle");
                        $('#circle'+count).addClass( "activeCircle circleImg" );
                    }
                    console.log(count);
                }else{
                    if(count<5){
